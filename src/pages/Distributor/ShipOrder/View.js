            ...
            <>
              <Grid item xs={2}>
                <p>
                  ...
                  {order.supplier_name}, {order.supplier_mobile}
                </p>
              </Grid>
              <Grid item xs={2}>
                <p>
                  <span>Order Number: </span> <br /> {order.order_no}
                </p>
              </Grid>
              <Grid item xs={2}>
                <p>
              ...
              <Grid item xs={2}>
                <p>
                  <span>Sub Total: </span> <br /> {order.sub_total}
                </p>
              </Grid>
              <Grid item xs={1}>
                <p>
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(ShipOrderViewPage))
);
