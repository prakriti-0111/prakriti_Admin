...
class MyOrderViewPage extends React.Component {
  ...
  render() {
    ...
    return (
      <MainCard
        title='Order Details'
        className='order-details-para'
        secondary={
          <Button
            variant='contained'
            onClick={() => this.props.navigate("/distributor/my-order")}>
            Back
          </Button>
        }>
        <Grid
          container
          spacing={gridSpacing}
          className='details-header ratn-pur-wrapper'>
          {!order ? (
            ...
            <>
              <Grid item xs={2}>
                <p>
                  <span>Order #: </span> <br /> {order.order_no}
                </p>
              </Grid>
              <Grid item xs={2}>
                <p>
                  <span>Order Date: </span> <br /> {order.order_date}
                </p>
              </Grid>
              <Grid item xs={2}>
                <p>
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(MyOrderViewPage))
);
