      ...
      <MainCard
        ...
        secondary={
          <Button
            ...
            onClick={() =>
              this.props.navigate(
                getUserDashboardRoute(getRoleName(this.state.auth)) + "/orders"
              )
            }>
            Back
          </Button>
        ...
        <Dialog
          ...
          fullWidth
          maxWidth='xs'>
          <DialogTitle>Order Assign</DialogTitle>
          <DialogContent>
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(OrderViewPage))
);
