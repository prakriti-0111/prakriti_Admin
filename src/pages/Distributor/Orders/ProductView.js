...
class ProductView extends React.Component {
  ...
  getImageContent = () => {
    ...
    if (imageList[imageListIndex].type == "video") {
      ...
      return (
        <img
          src={imageList[imageListIndex].path}
          style={{ maxWidth: "100%" }}
        />
      );
    }
    ...
    let data = {
      ...
      stock_id:
        product.type == "material"
          ...
          : product.sizes[this.state.sizeIndex].stock_id,
      materials:
        product.type == "material"
          ? product.stock.materials
          : product.sizes[this.state.sizeIndex].materials,
      size_id:
        product.type == "material"
          ? ""
          : product.sizes[this.state.sizeIndex].size_id,
    };
  ...
  render() {
    ...
    return (
      <MainCard title=''>
        <div>
          <Button variant='text' onClick={this.handleBack}>
            <ArrowBackIcon /> Back
          </Button>
          {/*{
                        product ? 
                  ...
                  <div className='price_breakup'>
                    ...
                    <ul>
                      {product.type == "material" ? (
                        ...
                        <>
                          {product.sizes[this.state.sizeIndex].materials.map(
                            (item, index) => (
                              <React.Fragment key={index}>
                                <li>{item.name}</li>
                                <li>{item.price_display}</li>
                          ...
                          <li>
                            {
                              product.sizes[this.state.sizeIndex]
                    ...
                    <ul>
                      ...
                      <li>
                        {product.type == "material"
                          ...
                          : product.sizes[this.state.sizeIndex].weight}{" "}
                        gram
                      </li>
                    </ul>
                    <hr />
                ...
                <div className='order_list_content'>
                  ...
                  <div className='ring-price'>
                    <span>
                      {" "}
                      {product.type == "material"
                        ? product.stock.total_price_display
                        : product.sizes[this.state.sizeIndex]
                            .total_price_display}{" "}
                    </span>
                  </div>
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(ProductView))
);
