            ...
            <div className='single-item-wrapper details-header'>
              <div className='single-item'>
                <p>
                  ...
                  {returnPurchase.supplier_name},{" "}
                  {returnPurchase.supplier_mobile}
                </p>
              </div>
              <div className='single-item'>
                <p>
                  <span>Invoice Number: </span> <br />{" "}
                  {returnPurchase.invoice_number}
                </p>
              </div>
              <div className='single-item'>
                <p>
                  <span>Invoice Date: </span> <br />{" "}
                  {returnPurchase.invoice_date}
                </p>
              </div>
              <div className='single-item'>
                <p>
                  <span>Return Date: </span> <br /> {returnPurchase.return_date}
                </p>
              </div>
              <div className='single-item'>
                <p>
                  <span>Bill Amount: </span> <br />
                  {returnPurchase.bill_amount}
                </p>
              </div>
              <div className='single-item'>
                <p>
                  <span>Total Return: </span> <br />
                  {returnPurchase.return_amount}
                </p>
              </div>
              <div className='single-item'>
                <div>
                  ...
                  {returnPurchase.status == "pending" ? (
                    <Chip
                      label={returnPurchase.status_display}
                      color='primary'
...
export default withSnackbar(
  withRouter(
    connect(mapStateToProps, mapDispatchToProps)(ReturnPurchaseViewPage)
  )
);
