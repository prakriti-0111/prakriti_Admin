...
class PurchaseOnApproveViewPage extends React.Component {
  ...
  render() {
    ...
    return (
      <MainCard title="Purchase On Approval Details">
            ...
            !purchase ?
              ...
              </Grid>
              {
                ...
                <div className='sale-view-button'>
                  <Button variant="contained" className='primary accept' onClick={() => this.handleStatusChange(4)}>Transfer To Purchase</Button>
...
export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(PurchaseOnApproveViewPage)));
