...
import {isDistributor, getRoleName, getUserDashboardRoute, hasPermission} from 'src/helpers/helper';

class PurchaseOnApprovePage extends Component {
          ...
          <Grid container spacing={2} columnSpacing={{ xs: 1, sm: 2, md: 2 }} className='tax-input loans_view p_view'>
            ...
            <Grid item xs={6} md={2} className='create-input'>
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="">All</MenuItem>
                  <MenuItem value="3">On Approval</MenuItem>
                  <MenuItem value="4">Transfer To Purchase</MenuItem>
...
export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(PurchaseOnApprovePage)));
