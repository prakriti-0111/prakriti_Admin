...
import {
  returnSaleView,
  returnSaleUpdateStatus,
} from "actions/superadmin/returnSale.actions";
            ...
            {returnSale ? (
              <>
                {returnSale.status == "pending" ? (
                  <Chip
                    label={returnSale.status_display}
                    color='primary'
                    className='approved_status'
                  />
                ) : (
                  <>
                    {returnSale.status == "accepted" ||
                    returnSale.status != "declined" ? (
                      <Chip
                        label={returnSale.status_display}
                        color='success'
                        className='approved_status'
        ...
        {!returnSale ? (
          ...
          <>
            <Grid container spacing={2} className='loans_view p_view'>
              ...
              <Grid item xs={12} md={9} className='create-input'></Grid>
                    ...
                    <>
                      {returnSale.status == "pending" ? (
                        <Button
                          ...
                          onClick={() =>
                            this.handleStatusChange("send_to_superadmin")
                          }>
                          Send to Superadmin
                        </Button>
                      ) : (
                        <>
                          {returnSale.status == "superadmin_declined" ? (
                            <Button
                              ...
                              className='primary accept'
                              onClick={() =>
                                this.handleStatusChange("declined_accept")
                              }>
                              Declined Accept
                            </Button>
                          ) : (
                            <>
                              {returnSale.status == "declined_accept" ? (
                                <Button
                                  ...
                                  className='primary accept'
                                  onClick={() =>
                                    this.handleStatusChange("send_to_customer")
                                  }>
                                  Send to Customer
                                </Button>
                              ) : null}
                                ...
                                <>
                                  ...
                                  "superadmin_accepted" ? (
                                    <Button
                                      ...
                                      className='primary accept'
                                      onClick={() =>
                                        this.handleStatusChange("complete")
                                      }>
                                      Purchase
                                    </Button>
                                  ) : null}
                              ...
                              {returnSale.status == "pending" ? (
                                <>
                                  ...
                                  <Button
                                    ...
                                    className='danger decline'
                                    onClick={() =>
                                      this.handleStatusChange("declined")
                                    }>
                                    Decline
                                  </Button>
                                </>
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(ReturnSaleViewPage))
);
