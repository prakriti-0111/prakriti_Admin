                      ...
                      <Card
                        ...
                        {this.state.price_by_categories.map((item, key) => (
                          <CardContent
                            ...
                            key={key}
                            onClick={() =>
                              this.handleCardClick(item.category_id)
                            }>
                            <Typography
                      ...
                      <Grid
                        ...
                        <Grid item xs={6} md={3} className='create-input'>
                          <FormControl fullWidth>
                            ...
                            <Select
                              value={
                                this.state.stockQueryParams.sub_category_id
                              }
                              label='Sub Category'
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(DistrubutorViewPage))
);
