                              ...
                              <TextField
                                ...
                                InputProps={{
                                  endAdornment: (
                                    <InputAdornment
                                      position='end'
                                      className='i-icon-right'>
                                      {performance.sale_achived_percent_display}
                                    </InputAdornment>
                                  ),
                                ...
                                InputProps={{
                                  endAdornment: (
                                    <InputAdornment
                                      ...
                                      className='i-icon-right'>
                                      {
                                        performance.visit_achived_percent_display
                                      }
                                    </InputAdornment>
                                  ),
                                  className: "non_disable_text",
...
export default withSnackbar(
  withRouter(connect(mapStateToProps, mapDispatchToProps)(MyPerformance))
);
