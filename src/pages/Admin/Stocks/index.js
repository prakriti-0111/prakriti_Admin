...
import { stocksList, getPriceByCategory } from 'actions/admin/stocks.actions';
import { subCategoryList } from 'actions/admin/subCategory.actions';
import { saleCartStore, saleCartList } from 'actions/admin/saleCart.actions';
import DataTable from 'src/utils/DataTable';
import { withSnackbar } from 'notistack';
import DiamondIcon from '@mui/icons-material/Diamond';
import GroupIcon from '@mui/icons-material/Group';
import {ADMIN_SALE_CART_RESET} from '../../actionTypes/admin/saleCart.types';
...
const mapStateToProps = (state) => ({
  items: state.admin.stocks.items,
  total: state.admin.stocks.total,
  actionCalled: state.admin.stocks.actionCalled,
  deleteSuccess: state.admin.stocks.deleteSuccess,
  successMessage: state.admin.stocks.successMessage,
  cart_actionCalled: state.admin.saleCart.actionCalled,
  cart_createSuccess: state.admin.saleCart.createSuccess,
  cart_deleteSuccess:  state.admin.saleCart.deleteSuccess,
  cart_successMessage: state.admin.saleCart.successMessage,
  cart_errorMessage: state.admin.saleCart.errorMessage,
  categories: state.admin.category.items,
  sub_categories: state.admin.subCategory.items,
});
