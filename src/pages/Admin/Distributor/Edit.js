...
import DistributorForm from "forms/Admin/DistributorForm";
import { bindActionCreators } from "redux";
import MainCard from "ui-component/cards/MainCard";
import withRouter from "src/helpers/withRouter";
import { distributorFetch } from "actions/admin/distributor.actions";
...
const mapStateToProps = (state) => ({
  item: state.admin.distributor.item || null,
});
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(DistributorEditPage)
);
