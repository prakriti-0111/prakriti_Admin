          ...
          <ButtonBase sx={{ borderRadius: "12px" }}>
            <Avatar
              ...
              <div className='c-heading'>
                <Badge badgeContent={totalCart} className='bg-transparent!'>
...
const mapDispatchToProps = (dispatch) => ({
  actions: bindActionCreators(
    { distributorSaleCartList, adminSaleCartList, superAdminCartList },
    dispatch
  ),
});

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(SaleCartSection)
);
