...
import { changePassword } from 'actions/superadmin/profile.actions';
...
const mapStateToProps = (state) => ({
    auth: state.auth,
    actionCalled: state.superadmin.profile.actionCalled,
    changePasswordSuccess: state.superadmin.profile.changePasswordSuccess,
    successMessage: state.superadmin.profile.successMessage,
    errorMessage: state.superadmin.profile.errorMessage,
	auth: state.auth
});
