...
import { changePassword } from 'actions/se/profile.actions';
import { withSnackbar } from 'notistack';
import LoadingButton from '@mui/lab/LoadingButton';
import withRouter from 'src/helpers/withRouter';
import {SE_PROFILE_RESET} from '../../actionTypes/se/profile.types';
...
const mapStateToProps = (state) => ({
    auth: state.auth,
    actionCalled: state.se.profile.actionCalled,
    changePasswordSuccess: state.se.profile.changePasswordSuccess,
    successMessage: state.se.profile.successMessage,
    errorMessage: state.se.profile.errorMessage
});
