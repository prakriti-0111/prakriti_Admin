...
import { distributorCreate, distributorUpdate } from 'actions/admin/distributor.actions';
...
const mapStateToProps = (state) => ({
  actionCalled: state.admin.distributor.actionCalled,
  createSuccess: state.admin.distributor.createSuccess,
  editSuccess: state.admin.distributor.editSuccess,
  successMessage: state.admin.distributor.successMessage,
  errorMessage: state.admin.distributor.errorMessage,
