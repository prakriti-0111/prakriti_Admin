...
import { changePassword } from 'actions/admin/profile.actions';
import { withSnackbar } from 'notistack';
import LoadingButton from '@mui/lab/LoadingButton';
import withRouter from 'src/helpers/withRouter';
import {ADMIN_PROFILE_RESET} from '../../actionTypes/admin/profile.types';
...
const mapStateToProps = (state) => ({
    auth: state.auth,
    actionCalled: state.admin.profile.actionCalled,
    changePasswordSuccess: state.admin.profile.changePasswordSuccess,
    successMessage: state.admin.profile.successMessage,
    errorMessage: state.admin.profile.errorMessage
});
