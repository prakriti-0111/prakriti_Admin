...
import { supplierCreate, supplierUpdate } from 'actions/superadmin/supplier.actions';
        ...
        if(this.state.actionCalled){
            if(this.state.isCreateFrom){
                if(this.state.createSuccess){
                    ...
                    this.props.navigate('/super-admin/suppliers');
                }else{
                    this.setState({
                        submitting: false
                    })
...
const mapStateToProps = (state) => ({
    actionCalled: state.superadmin.supplier.actionCalled,
    createSuccess: state.superadmin.supplier.createSuccess,
    editSuccess: state.superadmin.supplier.editSuccess,
    successMessage: state.superadmin.supplier.successMessage,
    errorMessage: state.superadmin.supplier.errorMessage,
