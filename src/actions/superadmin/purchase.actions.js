...
export const purchaseTxnLedgerList = (params) => {
  ...
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases/txn-ledger${params}`)
      .then((response) => {
...
export const purchaseList = (params) => {
  ...
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases${params}`)
      .then((response) => {
        if (response.data.success) {
          dispatch({
            type: LIST_PURCHASE,
...
export const purchaseOnApproveList = (params) => {
  ...
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases-on-approve${params}`)
      .then((response) => {
        if (response.data.success) {
          dispatch({
...
export const purchaseOnApproveView = (id) => {
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases-on-approve/view/${id}`)
      .then((response) => {
...
export const purchaseCreate = (params) => {
  ...
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases/create`)
      .then((response) => {
        if (response.data.success) {
          dispatch({
...
export const purchasePreStoreList = (params) => {
  ...
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases/pre-store-list${params}`)
      .then((response) => {
        if (response.data.success) {
          dispatch({
...
export const purchaseStore = (data) => {
  ...
  return (dispatch) => {
    axios
      .post("/superadmin/purchases/store", data)
      .then((response) => {
        dispatch({
          type: ADD_PURCHASE,
          payload: response.data,
...
export const purchaseViewRaw = (id) => {
...
export const purchaseView = (id) => {
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases/view/${id}`)
      .then((response) => {
        console.log(response.data.data);
        if (response.data.success) {
          dispatch({
...
export const purchaseEdit = (id) => {
  return (dispatch) => {
    axios
      .get(`/superadmin/purchases/edit/${id}`)
      .then((response) => {
        console.log(response.data.data);
        if (response.data.success) {
          dispatch({
...
export const purchaseUpdate = (id, data) => {
  return (dispatch) => {
    axios
      .post(`/superadmin/purchases/update/${id}`, data)
      .then((response) => {
        dispatch({
...
export const purchaseDelete = (id, data) => {
  return (dispatch) => {
    axios
      .delete(`/superadmin/purchases/delete/${id}`, data)
      .then((response) => {
        dispatch({
...
export const purchaseProductDelete = (purchaseId, productId) => {
  ...
  return axios.delete(
    `/superadmin/purchases/${purchaseId}/products/${productId}`,
  );
};
...
export const purchaseDownloadInvoiceItemDetails = (id) => {
  return axios.post(
    `/superadmin/purchases/download-invoice-item-details/${id}`,
  );
};

export const purchaseOnApprovalDownloadInvoiceInfo = (id) => {
  return axios.post(
    `/superadmin/purchases-on-approve/download-invoice-info/${id}`,
  );
};

export const purchaseOnApprovalDownloadInvoiceItemList = (id) => {
  return axios.post(
    `/superadmin/purchases-on-approve/download-invoice-item-list/${id}`,
  );
};

export const purchaseOnApprovalDownloadInvoiceItemDetails = (id) => {
  return axios.post(
    `/superadmin/purchases-on-approve/download-invoice-item-details/${id}`,
  );
};
